...
class _CreateEventViewState extends State<CreateEventView> {
              ...
              Obx(
                () => SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: controller.isCreating.value ? null : _handleCreateEvent,
  ...
  void _handleCreateEvent() async {
    ...
    String? bannerUrl = await controller.uploadBannerImage(_bannerImage!);
    ...
    final event = Event(
      eventId: '', // Generated by controller
      ...
      createdByUid: '', // Set by controller
      approved: false,
      enrolledCount: 0,
      conflict: false,
